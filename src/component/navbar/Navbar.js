            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  ...
                  <li><Link className="dropdown-item" to="/useCallbackexample">useCallback</Link></li>
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  ...
                  <li><Link className="dropdown-item" to="/normalcss">Normal Css</Link></li>
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  <li><Link className="nav-link" to="/hoc">Hoc</Link></li>
                  <li><Link className="nav-link" to="/hoctest">HocTest</Link></li>
                </ul>
              </li>
            </ul>
            {props.searchbar ?
